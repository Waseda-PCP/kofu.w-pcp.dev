      ...
      <body>
        ...
        <footer>
          <div className="footlogo">
            ...
            <h2>PCプログラミング部</h2>
            <h3>Links</h3>
            <a href="https://www.youtube.com/watch?v=fjxDzQjeaNs">YouTube (W-PCP)</a>
            <a href="https://www.youtube.com/shorts/FvWeI3yxi8o">YouTube Shorts (W-PCP)</a>
            <a href="https://x.com/waseda_pcp">X (旧 Twitter)</a>
            <br />
